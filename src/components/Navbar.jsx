  ...
  return (
    <>
      <div
        ...
        }  h-16 flex justify-between items-center relative shadow-2xl shadow-black px-10`}
      >
        {/* Logo */}
        ...
        <div className="hidden lg:flex">
          <ul className="flex gap-8">
            {navItems.map((item, index) => (
              ...
              >
                <p className="text-base hover:text-gray-400 transition">
                  {item}
                </p>
                <ul
                  className={`${
        ...
        <button
          ...
          className="hidden lg:block text-white bg-blue-600 px-4 py-2 rounded-md hover:bg-blue-500 transition"
        >
          Contact Us
        </button>
      </div>
